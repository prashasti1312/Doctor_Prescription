  ...
  return  docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 p-7 bg-white mx-2 mt-[-80px] sm:mt-0'>
          ...
          <p className='text-gray-500 font-medium mt-4'>
            Apppointment fee: <span className='text-gray-600'>{currencySymbol}{docInfo.fees}</span>
          </p>
        </div>
