...
const MyAppointments = () => {
  ...
  return (
    <div>
      <p className='pb-3 mt-2 font-medium text-zinc-700 border-b'>My Appointments</p>
      <div >
        {
          doctors.slice(0,3).map((item, index) =>(
            <div  className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b'key={index}>
              ...
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-xs mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time:</span> 13 Dec 2024| 8:30 pm</p>
              </div>
              <div></div>
